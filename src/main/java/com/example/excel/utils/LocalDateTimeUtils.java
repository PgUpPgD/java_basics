...
public class LocalDateTimeUtils {
     ...
     * @return
     */
    public static LocalDateTime next2MonthStartTime() {
        return LocalDateTime.of(LocalDate.now().plus(2L, ChronoUnit.MONTHS).with(TemporalAdjusters.firstDayOfMonth()), LocalTime.MIN);
    }
     ...
     * @return
     */
    public static LocalDateTime next2MonthEndTime() {
        return LocalDateTime.of(LocalDate.now().plus(2L, ChronoUnit.MONTHS).with(TemporalAdjusters.lastDayOfMonth()), LocalTime.MAX);
    }
     ...
     * @return
     */
    public static LocalDateTime next3MonthStartTime() {
        return LocalDateTime.of(LocalDate.now().plus(3L, ChronoUnit.MONTHS).with(TemporalAdjusters.firstDayOfMonth()), LocalTime.MIN);
    }
     ...
     * @return
     */
    public static LocalDateTime next3MonthEndTime() {
        return LocalDateTime.of(LocalDate.now().plus(3L, ChronoUnit.MONTHS).with(TemporalAdjusters.lastDayOfMonth()), LocalTime.MAX);
    }
     ...
     * @return
     */
    public static LocalDateTime next4MonthStartTime() {
        return LocalDateTime.of(LocalDate.now().plus(4L, ChronoUnit.MONTHS).with(TemporalAdjusters.firstDayOfMonth()), LocalTime.MIN);
    }
     ...
     * @return
     */
    public static LocalDateTime next4MonthEndTime() {
        return LocalDateTime.of(LocalDate.now().plus(4L, ChronoUnit.MONTHS).with(TemporalAdjusters.lastDayOfMonth()), LocalTime.MAX);
    }
     ...
     * @return
     */
    public static LocalDateTime next5MonthStartTime() {
        return LocalDateTime.of(LocalDate.now().plus(5L, ChronoUnit.MONTHS).with(TemporalAdjusters.firstDayOfMonth()), LocalTime.MIN);
    }
     ...
     * @return
     */
    public static LocalDateTime next5MonthEndTime() {
        return LocalDateTime.of(LocalDate.now().plus(5L, ChronoUnit.MONTHS).with(TemporalAdjusters.lastDayOfMonth()), LocalTime.MAX);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("从当前开始第二个月开始时间：" + next2MonthStartTime());
        System.out.println("从当前开始第二个月结束时间：" + next2MonthEndTime());
        System.out.println("从当前开始第三个月开始时间：" + next3MonthStartTime());
        System.out.println("从当前开始第三个月结束时间：" + next3MonthEndTime());
        System.out.println("从当前开始第四个月开始时间：" + next4MonthStartTime());
        System.out.println("从当前开始第四个月结束时间：" + next4MonthEndTime());
        System.out.println("从当前开始第五个月开始时间：" + next5MonthStartTime());
        System.out.println("从当前开始第五个月结束时间：" + next5MonthEndTime());
